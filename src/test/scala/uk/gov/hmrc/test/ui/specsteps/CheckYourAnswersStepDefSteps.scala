...
object CheckYourAnswersStepDefSteps {
  ...
  def thenTheUserIsPresentedWithChangeLinkNextToTheDistributionAmount(): Unit = {
    CheckYourAnswersPage.changeLinkForDistributions()
  }

  // the user can validate their distribution amount as {string}
  def thenTheUserCanValidateTheirDistributionAmountAs(distributionsAmount: String): Unit = {
  ...
  def whenTheUserClicksTheCalculateMarginalReliefButtonOnTheCheckYourAnswersPage(): Unit = {
    eventually {
  ...
  def andTheUserCanSeeTheCalculateMarginReliefButtonEnabled(): Unit = {
    CheckYourAnswersPage.verifyMRCButtonEnabled()
  }

  // the user can click on the calculate margin relief button
  def whenTheUserCanClickOnTheCalculateMarginReliefButton(): Unit = {
    CheckYourAnswersPage.clickMRCButton()
  }

  // the user can validate the accounting period as {string}
  def thenTheUserCanValidateTheAccountingPeriodAs(accountingPeriod: String): Unit = {
  ...
  def thenTheUserValidatesAssociatedCompaniesForTheSecondPartOfFinancialYearAs(ac: String): Unit = {
