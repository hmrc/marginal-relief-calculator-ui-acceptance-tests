  ...
  Feature("Edit Associated Companies - Validations") {
    ...
    Scenario("Edit Associated Companies") {
      And("the user is presented with a change link next to the associated companies")
        ...
        thenTheUserIsPresentedWithAChangeLinkNextToTheAssociatedCompanies()
        // --- Other possible matches ---
        // thenTheUserClicksTheChangeLinkNextToTheAssociatedCompanies() [0.79] (CheckYourAnswersStepDefSteps.scala) pattern: the user clicks the change link next to the associated companies
      ...
      And("the user clicks the change link next to the associated companies")
        // Possible match (best=1.00)
        thenTheUserClicksTheChangeLinkNextToTheAssociatedCompanies()
